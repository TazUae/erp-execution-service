...
/** HTTP-only ERP integration: Bearer auth and timeouts; provisioning via HttpProvisioningClient (next step). */
const EnvSchema = z.object({
   ...
   * Not consumed until HttpProvisioningClient is implemented.
   */
